package net.prehistoricdiner.init;
...
public class ModItems {
    ...
    public static final Item valleymans_beans = null;
    ...
    public static final Item rolling_pin = null;
    public static final Item ladle = null;
