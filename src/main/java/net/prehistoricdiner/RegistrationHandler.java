...
public class RegistrationHandler {
    ...
    public static void registerItems(RegistryEvent.Register<Item> event) {
        Item[] items = new Item[]{
                ...
                ((Item)(new ItemFood(1, 1F, false)).setRegistryName("prehistoricdiner", "valleymans_beans")).setTranslationKey("prehistoricdiner.valleymans_beans").setCreativeTab(PrehistoricDiner.CREATIVE_TAB),
